...
// TODO: Add additional support for other platforms at some point.
...
auto abs_exe_directory() -> std::filesystem::path { return abs_exe_path().parent_path(); }
	...
	/* TODO: Once we've decided what our asset and resources will look like then we can handle this.
