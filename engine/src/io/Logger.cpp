...
#if defined(_WIN32)
#include "nimbus/core/platform/win32/Windows.hpp"
#endif


namespace nim::io::logger
{
...
namespace nim::io::logger
{
    namespace
    {
        ...
        struct Formatter
        {
            ...
            struct Data
            {
                ntl::FixedString<Config::format_size_v> format{};
                Timestamp timestamp{};
            };
    ...
    // ReSharper disable once CppDFAMemoryLeak - This will not leak.
...
} // namespace nim::logger

namespace nim::io
{
    void logger::print(Level level, std::string_view category, std::string_view message)
    {
