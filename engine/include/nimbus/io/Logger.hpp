...
#include "nimbus/ntl/FixedString.hpp"
...
namespace nim::io::logger {
    ...
    struct Target {
        ...
        constexpr operator std::uint32_t() const { return value; } // NOLINT
    };
    ...
    struct Config {
         ...
         */
        ntl::FixedString<format_size_v> format{default_format_v};
    ...
    public:
         ...
         */
        explicit Instance(char const *filePath = "nimbus.log", Config config = {});
